 ...
 * Use the [TambahSupFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TambahSupFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_tambah_sup, container, false)
            ...
            if(status=="edit"){
                api.putProduk(token.toString(),produk?.id.toString().toInt(),adminId.toString().toInt(),txtFormNama.text.toString(),txtFormHarga.text.toString().toInt(),txtFormStok.text.toString().toInt()).enqueue(object :
                    ...
                    override fun onResponse(
                        ...
                        Toast.makeText(activity?.applicationContext, "Data "+ response.body()!!.data.produk.nama.toString() +" di Edit",
